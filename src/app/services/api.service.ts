...
//     }
    ...
    getEpisodes() 
    {
    return this.http.get(`https://nameless-wave-71362.herokuapp.com/episodes`)
    }

    getEpisode(id: any) 
    {
    return this.http.get(`https://nameless-wave-71362.herokuapp.com/episodes/${id}`)
    }
    ...
    getCharacters() 
    {
    return this.http.get(`https://nameless-wave-71362.herokuapp.com/characters`)
    }
    ...
    //findQuote(search: any) {
        ...
        //return this.http.get(`http://breakingbadapi.com/api/quote?author=${search}`).pipe(new Map( (quote: any) => {
    //        return quote;
    //    })
